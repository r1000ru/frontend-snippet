...
var namespace = 'window.mycompany = window.mycompany || {}; window.mycompany.project = window.mycompany.project || {}; window.mycompany.project.html'
...
var build = function() {
    ...
    fs.readdir(appPath, (err, files) => {
        ...
        files.forEach(file => {
            ...
            try {
                appCSS += fs.readFileSync(appPath + '/' +file + '/' + file + '.css')
            } catch(e) {
            ...
            try {
                appTemplates[file] = fs.readFileSync(appPath + '/' + file + '/' + file + '.html') + ';';
            } catch(e) {
